 ...
 * @LastEditTime: 2022-11-30 00:30:16
...
<template>
  <div class="w-screen p-t-12 relative">
    ...
    <van-row m-4 gutter="20">
      <van-col span="12">
        <div chart-bg b-rd p-2>
          <p class="text-[#aaa]">
            Overview
          </p>
          <h3 class="pt-36px text-24px font-bold text-right">
    ...
    <div class="chart-bg b-rd m-4">
      <div ref="lineRef" class="w-full h-200px" />
    </div>
    <div class="chart-bg b-rd m-4">
      <div ref="pieRef" class="w-full h-360px" />
    </div>
  </div>
</template>
